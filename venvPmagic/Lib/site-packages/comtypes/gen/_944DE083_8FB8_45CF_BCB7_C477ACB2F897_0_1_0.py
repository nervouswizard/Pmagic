...
__all__ = [
    ...
    'UIA_SizePropertyId', 'IUIAutomationEventHandlerGroup',
    'IUIAutomationElement3', 'UIA_NamePropertyId',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_SelectionPatternId', 'UIA_IsValuePatternAvailablePropertyId',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'UIA_ObjectModelPatternId', 'UIA_IndentationFirstLineAttributeId',
    'UIA_UnderlineColorAttributeId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'ProviderOptions_ProviderOwnsSetFocus',
    'UIA_AnnotationObjectsPropertyId', 'AnnotationType_SpellingError',
    'IUIAutomationTextRangeArray', 'UIA_CheckBoxControlTypeId',
    'UIA_LineSpacingAttributeId',
    'IUIAutomationVirtualizedItemPattern', 'UIA_AriaRolePropertyId',
    'IUIAutomation2', 'TreeScope', 'IUIAutomationTextRange2',
    'AnnotationType_Footnote', 'SynchronizedInputType_KeyUp',
    'UIA_ListItemControlTypeId',
    'UIA_Transform2ZoomMaximumPropertyId', 'IUIAutomation',
    'UIA_DataGridControlTypeId', 'UIA_GridItemColumnPropertyId',
    'IUIAutomation4', 'UIA_SearchLandmarkTypeId',
    'IUIAutomationTransformPattern', 'AnnotationType_DeletionChange',
    'WindowInteractionState_NotResponding',
    'TextEditChangeType_CompositionFinalized',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'UIA_WindowCanMinimizePropertyId', 'ExtendedProperty',
    'UIA_ControlTypePropertyId', 'ScrollAmount_NoAmount',
    'UIA_IsAnnotationPatternAvailablePropertyId', 'ProviderOptions',
    'IUIAutomationProxyFactoryEntry', 'TreeTraversalOptions_Default',
    'IUIAutomationNotCondition', 'UIA_GridRowCountPropertyId',
    ...
    'UIA_LayoutInvalidatedEventId', 'IUIAutomationGridItemPattern',
    'UIA_GridItemColumnSpanPropertyId', 'UIA_ItemContainerPatternId',
    'IUIAutomationTextRange3', 'UIA_Text_TextSelectionChangedEventId',
    'UIA_LiveRegionChangedEventId', 'UIA_DropTarget_DragLeaveEventId',
    'AnnotationType_AdvancedProofingIssue',
    'IUIAutomationMultipleViewPattern',
    'UIA_NavigationLandmarkTypeId', 'NavigateDirection_Parent',
    'UIA_ComboBoxControlTypeId', 'UIA_AppBarControlTypeId',
    'AutomationElementMode_Full', 'IUIAutomationElement',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'IUIAutomationTablePattern', 'UIA_StylesStyleNamePropertyId',
    'UIA_TableColumnHeadersPropertyId', 'UIA_WindowPatternId',
    'UIA_MarginLeadingAttributeId', 'UIA_MenuItemControlTypeId',
    'UIA_WindowWindowVisualStatePropertyId',
    'UIA_IsDockPatternAvailablePropertyId',
    'AnnotationType_EditingLockedChange',
    'UIA_DragDropEffectsPropertyId', 'IUIAutomationElement9',
    'TextUnit_Word', 'WindowVisualState', 'UIA_FillColorPropertyId',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'AnnotationType_Highlighted', 'IUIAutomationChangesEventHandler',
    ...
    'PropertyConditionFlags_IgnoreCase', 'TextUnit_Character',
    'UIA_MenuModeEndEventId', 'UIA_SeparatorControlTypeId',
    'UIA_PaneControlTypeId', 'UIA_EditControlTypeId',
    'UIA_SayAsInterpretAsMetadataId',
    'AnnotationType_InsertionChange',
    'SynchronizedInputType_RightMouseUp', 'TextUnit_Paragraph',
    'IUIAutomationTableItemPattern',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_OutlineThicknessPropertyId',
    'UIA_IsTogglePatternAvailablePropertyId', 'NavigateDirection',
    'WindowInteractionState_Closing',
    'UIA_ToggleToggleStatePropertyId', 'ZoomUnit_SmallDecrement',
    'UIA_AnnotationAuthorPropertyId', 'CoalesceEventsOptions',
    'SynchronizedInputType_LeftMouseDown', 'StyleId_Heading5',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_TabsAttributeId', 'IUIAutomationElement7',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_ProgressBarControlTypeId',
    'ProviderOptions_UseClientCoordinates',
    'UIA_StylesShapePropertyId', 'TreeScope_Descendants',
    'UIA_StylesStyleIdPropertyId', 'ToggleState', 'StyleId_Custom',
    'UIA_ToolTipControlTypeId',
    'UIA_StylesExtendedPropertiesPropertyId',
    'UIA_ProviderDescriptionPropertyId', 'HeadingLevel6',
    'UIA_MenuOpenedEventId', 'AnnotationType_Unknown', 'Off',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_ItemTypePropertyId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'ProviderOptions_ServerSideProvider', 'UIA_DragPatternId',
    'UIA_UnderlineStyleAttributeId', 'AnnotationType_Sensitive',
    'UIA_IsActiveAttributeId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'SupportedTextSelection_Single', 'AnnotationType_FormatChange',
    'AnnotationType_ConflictingChange', 'UIA_SystemAlertEventId',
    'AutomationElementMode', 'UIA_TabControlTypeId',
    'UIA_CulturePropertyId', 'UIA_ValueValuePropertyId',
    'UIA_HasKeyboardFocusPropertyId', 'UIA_WindowControlTypeId',
    'IUIAutomationCondition', 'UIA_MarginTopAttributeId',
    'IUIAutomationElement4', 'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_RangeValueLargeChangePropertyId', 'StyleId_Heading7',
    'ProviderOptions_UseComThreading', 'AnnotationType_FormulaError',
    'StyleId_Normal', 'UIA_ScrollItemPatternId', 'StyleId_Heading8',
    ...
    'UIA_StructureChangedEventId', 'UIA_MenuBarControlTypeId',
    'TextUnit', 'UIA_DockPatternId', 'UIA_SpreadsheetPatternId',
    'IUIAutomation5', 'StyleId_Heading9', 'HeadingLevel1',
    'UIA_GridPatternId', 'HeadingLevel8', 'UIA_StyleNameAttributeId',
    'UIA_IsHiddenAttributeId',
    'UIA_AnnotationAnnotationTypeIdPropertyId', 'UIA_TogglePatternId',
    'UIA_SelectionIsSelectionRequiredPropertyId', 'DockPosition_Left',
    'UIA_AutomationPropertyChangedEventId', 'UIA_CultureAttributeId',
    'UIA_ExpandCollapsePatternId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_DockDockPositionPropertyId',
    'UIA_LegacyIAccessibleRolePropertyId',
    'UIA_TextEdit_TextChangedEventId', 'PropertyConditionFlags_None',
    'StyleId_Heading3', 'UIA_InvokePatternId', 'DockPosition_Fill',
    'UIA_BeforeParagraphSpacingAttributeId',
    'UIA_OverlineColorAttributeId', 'UIA_DropTargetPatternId',
    'UIA_TablePatternId', 'UIA_ThumbControlTypeId',
    'IUIAutomationScrollPattern', 'UIA_VisualEffectsPropertyId',
    'UIA_AcceleratorKeyPropertyId', 'IUIAutomationElement2',
    'UIA_FormLandmarkTypeId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_ScrollVerticalViewSizePropertyId',
    'UIA_StylesFillPatternColorPropertyId', 'UIA_HeaderControlTypeId',
    'NotificationKind_ItemAdded',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'AnnotationType_Endnote', 'LiveSetting',
    'UIA_FrameworkIdPropertyId', 'UIA_BulletStyleAttributeId',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'UIA_WindowCanMaximizePropertyId',
    'UIA_DropTarget_DroppedEventId', 'UIA_HyperlinkControlTypeId',
    ...
    'NotificationKind_ActionAborted', 'IUIAutomationDockPattern',
    'UIA_GridItemRowPropertyId',
    'UIA_LegacyIAccessibleNamePropertyId',
    'WindowInteractionState_Running', 'NavigateDirection_NextSibling',
    'StyleId_Title', 'IUIAutomationOrCondition',
    'IUIAutomationAndCondition', 'UIA_RuntimeIdPropertyId',
    'StructureChangeType_ChildrenBulkAdded',
    'ScrollAmount_SmallIncrement',
    'ProviderOptions_ClientSideProvider', 'RowOrColumnMajor',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_OutlineColorPropertyId', 'UIA_GridItemRowSpanPropertyId',
    'UIA_HelpTextPropertyId', 'IUIAutomationCustomNavigationPattern',
    'UIA_TextEditPatternId', 'TreeTraversalOptions_LastToFirstOrder',
    'UIA_TransformCanRotatePropertyId',
    'ExpandCollapseState_Expanded', 'IUIAutomationTextPattern',
    'UIA_HeaderItemControlTypeId',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_TextEdit_ConversionTargetChangedEventId', 'HeadingLevel5',
    'UIA_FullDescriptionPropertyId', 'TreeScope_Element',
    'UIA_TableRowOrColumnMajorPropertyId',
    'UIA_AnnotationTypesAttributeId', 'UIA_FontWeightAttributeId',
    ...
    'DockPosition_Top', 'UIA_ToolTipClosedEventId',
    'ExpandCollapseState_Collapsed', 'TreeTraversalOptions',
    'AnnotationType_Header', 'IUIAutomationGridPattern',
    'ScrollAmount_LargeIncrement', 'UIA_RangeValueValuePropertyId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_SayAsInterpretAsAttributeId',
    'UIA_Transform2ZoomMinimumPropertyId',
    'UIA_RadioButtonControlTypeId', 'ZoomUnit_SmallIncrement',
    ...
    'UIA_StylesFillColorPropertyId', 'IUIAutomationDropTargetPattern',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'IUIAutomationTextChildPattern',
    'IUIAutomationProxyFactoryMapping', 'OrientationType_None',
    ...
    'IUIAutomationValuePattern', 'ScrollAmount_LargeDecrement',
    ...
    'UIA_CaretBidiModeAttributeId', 'IUIAutomation3',
    'UIA_GroupControlTypeId', 'UIA_NotificationEventId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_IsOffscreenPropertyId', 'UIA_CalendarControlTypeId',
    'TextEditChangeType_None',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_LevelPropertyId', 'UIA_ClickablePointPropertyId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'UIA_IsKeyboardFocusablePropertyId',
    'AnnotationType_DataValidationError', 'SupportedTextSelection',
    ...
    'UIA_LegacyIAccessibleHelpPropertyId', 'OrientationType_Vertical',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_DragIsGrabbedPropertyId', 'PropertyConditionFlags',
    'UIA_RotationPropertyId', 'UIA_SizeOfSetPropertyId',
    'NotificationProcessing_ImportantAll',
    'UIA_LocalizedControlTypePropertyId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_StyleIdAttributeId', 'TextEditChangeType_Composition',
    'StyleId_BulletedList', 'UIA_SemanticZoomControlTypeId',
    'UIA_AccessKeyPropertyId', 'UIA_AutomationFocusChangedEventId',
    'IUIAutomationProxyFactory', 'NotificationProcessing_MostRecent',
    'HeadingLevel3', 'UIA_ImageControlTypeId', 'HeadingLevel7',
    'UIA_StrikethroughColorAttributeId',
    'ProviderOptions_NonClientAreaProvider',
    'UIA_IsControlElementPropertyId', 'UIA_AsyncContentLoadedEventId',
    'UIA_AnnotationTargetPropertyId', 'IUIAutomationTextPattern2',
    'UIA_TableRowHeadersPropertyId', 'UIA_ToolTipOpenedEventId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'SynchronizedInputType_LeftMouseUp',
    'IUIAutomationSpreadsheetItemPattern',
    'UIA_RangeValueMinimumPropertyId', 'IUIAutomationTogglePattern',
    'UIA_SynchronizedInputPatternId', 'UIA_CustomControlTypeId',
    'AnnotationType_MoveChange', 'AnnotationType_Mathematics',
    'DockPosition', 'IUIAutomationSynchronizedInputPattern',
    'UIA_Window_WindowOpenedEventId', 'NotificationKind_Other',
    'ProviderOptions_RefuseNonClientSupport',
    'AnnotationType_ExternalChange', 'IUIAutomationRangeValuePattern',
    'IUIAutomationStylesPattern', 'UIA_ScrollBarControlTypeId',
    'DockPosition_None', 'NotificationProcessing_All',
    'UIA_ScrollPatternId', 'IUIAutomationSelectionItemPattern',
    'UIA_TextFlowDirectionsAttributeId',
    'SynchronizedInputType_KeyDown', 'TextPatternRangeEndpoint_End',
    'StyleId_Heading6', 'AnnotationType_TrackChanges',
    'IUIAutomationElement8', 'UIA_DataItemControlTypeId',
    'UIA_Selection2ItemCountPropertyId', 'UIA_IsDialogPropertyId',
    'UIA_TransformPattern2Id', 'UIA_InputReachedTargetEventId',
    'UIA_IndentationLeadingAttributeId', 'TreeScope_Parent',
    'OrientationType_Horizontal', 'UIA_IsReadOnlyAttributeId',
    'TextUnit_Format', 'TextEditChangeType_AutoComplete',
    ...
    'StructureChangeType_ChildRemoved', 'StyleId_Heading4',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_RangeValueSmallChangePropertyId', 'TextUnit_Line',
    'IUIAutomationTextEditTextChangedEventHandler',
    'WindowVisualState_Normal', 'ConnectionRecoveryBehaviorOptions',
    'UIA_WindowIsModalPropertyId',
    'UIA_IndentationTrailingAttributeId',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'IUIAutomationCacheRequest', 'DockPosition_Right',
    'UIA_GridColumnCountPropertyId', 'AutomationElementMode_None',
    'UIA_AnnotationTypesPropertyId',
    'SynchronizedInputType_RightMouseDown', 'UIA_FontNameAttributeId',
    'StyleId_Quote', 'IUIAutomationObjectModelPattern',
    'UIA_ItemStatusPropertyId',
    'IUIAutomationFocusChangedEventHandler',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'AnnotationType_GrammarError', 'Polite',
    'UIA_IsRequiredForFormPropertyId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_FlowsFromPropertyId', 'WindowInteractionState',
    'UIA_LegacyIAccessiblePatternId', 'IUIAutomationDragPattern',
    'UIA_FontSizeAttributeId', 'UIA_InputDiscardedEventId',
    'UIA_VirtualizedItemPatternId', 'UIA_CaretPositionAttributeId',
    'UIA_TreeControlTypeId', 'ZoomUnit', 'UIA_CapStyleAttributeId',
    'UIA_OutlineStylesAttributeId',
    'NavigateDirection_PreviousSibling',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'ToggleState_Off', 'UIA_TextPattern2Id', 'Assertive',
    'UIA_ListControlTypeId', 'UIA_DescribedByPropertyId',
    'UIA_StylesPatternId', 'DockPosition_Bottom',
    'UIA_ActiveTextPositionChangedEventId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_TabItemControlTypeId', 'OrientationType',
    ...
    'UIA_Drag_DragCompleteEventId', 'IUIAutomationSpreadsheetPattern',
    'SynchronizedInputType',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_Transform2CanZoomPropertyId', 'UIA_TableControlTypeId',
    'UIA_IsContentElementPropertyId', 'UIA_AnimationStyleAttributeId',
    'CoalesceEventsOptions_Enabled', 'WindowVisualState_Maximized',
    ...
    'AnnotationType_Comment', 'StyleId_Heading1',
    'UIA_BoundingRectanglePropertyId', 'UIA_IsEnabledPropertyId',
    'IUIAutomationElement5', 'UIA_SummaryChangeId',
    'IUIAutomationInvokePattern',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'UIA_MainLandmarkTypeId', 'UIA_Selection_InvalidatedEventId',
    'HeadingLevel4', 'ToggleState_Indeterminate',
    'UIA_ControllerForPropertyId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'UIA_IsWindowPatternAvailablePropertyId',
    'UIA_TreeItemControlTypeId', 'CoalesceEventsOptions_Disabled',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_GridItemPatternId', 'UIA_FlowsToPropertyId',
    'UIA_ValueIsReadOnlyPropertyId', 'StructureChangeType_ChildAdded',
    'CUIAutomation8', 'IUIAutomation6', 'IAccessible',
    'UIA_ScrollHorizontalViewSizePropertyId', 'UIA_TextControlTypeId',
    'UIA_TextChildPatternId', 'UIA_LandmarkTypePropertyId',
    'NotificationProcessing_ImportantMostRecent',
    'UIA_ForegroundColorAttributeId', 'HeadingLevel_None',
    'SupportedTextSelection_None', 'StyleId_Heading2',
    'IUIAutomationPropertyChangedEventHandler',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_SplitButtonControlTypeId', 'ExpandCollapseState',
    'CUIAutomation', 'TextUnit_Document', 'ScrollAmount',
    'UIA_OptimizeForVisualContentPropertyId', 'NotificationKind',
    'UIA_Text_TextChangedEventId', 'IUIAutomationSelectionPattern2',
    'SupportedTextSelection_Multiple', 'UIA_RangeValuePatternId',
    'UIA_IsSubscriptAttributeId', 'IRawElementProviderSimple',
    'TreeScope_Subtree', 'TreeScope_Ancestors',
    'RowOrColumnMajor_Indeterminate', 'UIA_DocumentControlTypeId',
    'UIA_SelectionItemPatternId', 'AnnotationType_UnsyncedChange',
    'UIA_WindowIsTopmostPropertyId',
    'IUIAutomationItemContainerPattern',
    'TreeTraversalOptions_PostOrder', 'UIA_MenuModeStartEventId',
    'ZoomUnit_NoAmount', 'TextEditChangeType_AutoCorrect',
    'UIA_StylesFillPatternStylePropertyId',
    'NavigateDirection_FirstChild', 'UIA_ProcessIdPropertyId',
    'UIA_LinkAttributeId', 'UIA_LiveSettingPropertyId',
    'UIA_SliderControlTypeId', 'UIA_TitleBarControlTypeId',
    'RowOrColumnMajor_ColumnMajor', 'RowOrColumnMajor_RowMajor',
    'StyleId_Subtitle', 'ZoomUnit_LargeIncrement',
    'ProviderOptions_HasNativeIAccessible',
    'IUIAutomationPropertyCondition',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'NotificationProcessing', 'UIA_InputReachedOtherElementEventId',
    'NotificationKind_ItemRemoved', 'ToggleState_On',
    'IUIAutomationElement6', 'UIA_ValuePatternId',
    'TextPatternRangeEndpoint', 'UIA_PositionInSetPropertyId',
    ...
    'UIA_MarginBottomAttributeId', 'UIA_AnnotationDateTimePropertyId',
    'IUIAutomationNotificationEventHandler', 'HeadingLevel2',
    'UIA_IsTextPatternAvailablePropertyId',
    'UIA_HorizontalTextAlignmentAttributeId', 'TreeScope_None',
    'ScrollAmount_SmallDecrement', 'NotificationKind_ActionCompleted',
    'UIA_Drag_DragStartEventId', 'UIA_BackgroundColorAttributeId',
    'UIA_MarginTrailingAttributeId', 'AnnotationType_Footer',
    'IUIAutomationBoolCondition', 'UIA_DragGrabbedItemsPropertyId',
    ...
    'UIA_MultipleViewPatternId', 'UIA_Transform2ZoomLevelPropertyId',
    'UIA_LegacyIAccessibleDescriptionPropertyId', 'TextUnit_Page',
    'UIA_AutomationIdPropertyId', 'UIA_LabeledByPropertyId',
    'UiaChangeInfo', 'UIA_TransformPatternId',
    'AnnotationType_Author', 'UIA_IsItalicAttributeId',
    'UIA_TransformCanMovePropertyId',
    'UIA_RangeValueMaximumPropertyId', 'UIA_SelectionPattern2Id',
...
_check_version('1.1.14', 1655404189.067186)
